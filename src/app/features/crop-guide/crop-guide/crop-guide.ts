...
export class CropGuideComponent {
  ...
  protected readonly crops: CropItem[] = [
    ...
    { id:13, name:'Other Rabi pulses', category:'pulses', image:'Other Rabi pulses.webp', season:'Rabi', soilType:'Loam', climate:'Cool dry', fertilization:{npk:'20:40:20 kg/ha',organic:'FYM',micronutrients:'B'}, waterRequirement:'Low-moderate', temperature:'15-25°C' },
    { id:14, name:'Potato', category:'vegetables', image:'Potato.webp', season:'Rabi', soilType:'Sandy loam', climate:'Cool', fertilization:{npk:'180:80:100 kg/ha',organic:'FYM',micronutrients:'Zn,B'}, waterRequirement:'Moderate', temperature:'15-25°C' },
